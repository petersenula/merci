  ...
  try {
    ...
    if (!schemeId) {
      ...
      const intent = await stripe.paymentIntents.create({
        ...
        metadata: {
          ...
          platform_fee_cents: String(paymentBreakdown.platformFeeCents),
          stripe_fee_cents: String(paymentBreakdown.stripeFeeCents),
          recipient_net_cents: String(paymentBreakdown.recipientNetCents),
    ...
    const intent = await stripe.paymentIntents.create({
      ...
      metadata: {
        ...
        review_text: normalizedReviewText,
        fee_percent: String(feePercent),
        account_currency: schemeCurrency,
        stripe_fee_pricing_key: stripeFeeProfile.pricingKey,
        tip_amount_cents: String(paymentBreakdown.tipAmountCents),
        fee_coverage_cents: String(paymentBreakdown.feeCoverageCents),
        platform_fee_cents: String(paymentBreakdown.platformFeeCents),
